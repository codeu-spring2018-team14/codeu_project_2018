...
public class PersistentStorageAgent {
  ...
  /**
   * Retrieve all User Profile objects from the Datastore service. The returned list may be empty.
   *
   * @throws PersistentDataStoreException if an error was detected during the load from the
   *     Datastore service
   */
  ...
  /** Write a User Profile object to the Datastore service. */
  public void writeThrough(UserProfile profile) {
